...
"""--include=
 ...
 libpam-ldapd nftables python3-gi procps kmod unscd gir1.2-notify-0.7 libcdio-utils python3-systemd libgtk-4-bin x11vnc ir-keytable python3-xdg  gir1.2-gtk-3.0 libgs10 libnss-ldapd python3-pyudev gir1.2-wnck-3.0
