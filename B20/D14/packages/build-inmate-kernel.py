...
with tempfile.TemporaryDirectory() as td_str:
    ...
    subprocess.check_call(
         ...
         *(['--include=curl ca-certificates tiny-initramfs',
         ...
         '--essential-hook=upload ../templates/main/files/apt-preferences-backports.conf /etc/apt/preferences.d/fuck',
         ...
         *(['--include=curl ca-certificates devscripts debian-keyring',
         ...
         '--customize-hook=chroot $1 env -i TERM="$TERM" PATH=/bin:/sbin python3 build-inmate-kernel-inner.py              || chroot $1 bash',
