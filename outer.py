...
subprocess.check_call([
    ...
    '--include=python3 linux-image-cloud-amd64 systemd-ukify systemd-boot-efi sbsigntool qemu-system-x86 ovmf python3-virt-firmware uuid-runtime parted mtools',
